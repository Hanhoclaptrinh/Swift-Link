...
import { Link2, Copy, CheckCircle, ArrowRight, Activity, Zap, Scissors } from 'lucide-react';
...
function App() {
  ...
  const handleShorten = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const newItem = { shortUrl: newShortUrl, originalUrl: url };
                ...
                {recentUrls.map((item, index) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="p-3 bg-agent-900/50 border border-white/10 hover:border-agent-accent/50 hover:bg-agent-accent/20 hover:text-agent-accent shadow-lg hover:shadow-neon-cyan rounded-lg transition-all text-slate-300 self-end sm:self-auto shrink-0 relative z-20"
